...
func (m *WebhookMutation) SetAppName(s string) {
	m.app_name = &s
}

// AppName returns the value of the "app_name" field in the mutation.
func (m *WebhookMutation) AppName() (r string, exists bool) {
	v := m.app_name
	if v == nil {
		return
	}
...
// OldAppName returns the old "app_name" field's value of the Webhook entity.
// If the Webhook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *WebhookMutation) OldAppName(ctx context.Context) (v string, err error) {
...
func (m *WebhookMutation) ResetAppName() {
	m.app_name = nil
}

// SetWebhookURL sets the "webhook_url" field.
func (m *WebhookMutation) SetWebhookURL(s string) {
	m.webhook_url = &s
}

// WebhookURL returns the value of the "webhook_url" field in the mutation.
func (m *WebhookMutation) WebhookURL() (r string, exists bool) {
	v := m.webhook_url
	if v == nil {
		return
	}
...
// OldWebhookURL returns the old "webhook_url" field's value of the Webhook entity.
// If the Webhook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *WebhookMutation) OldWebhookURL(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *WebhookMutation) ResetWebhookURL() {
	m.webhook_url = nil
}
...
func (m *WebhookMutation) Fields() []string {
	...
	if m.app_name != nil {
		fields = append(fields, webhook.FieldAppName)
	}
	if m.webhook_url != nil {
		fields = append(fields, webhook.FieldWebhookURL)
	}
	if m.created_at != nil {
